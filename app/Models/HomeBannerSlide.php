...
class HomeBannerSlide extends Model
{
    ...
    protected $fillable = ['image_path','mobile_image_path','title_fr','title_en','subtitle_fr','subtitle_en','description_fr','description_en','cta_label_fr','cta_label_en','cta_url','sort_order','is_active','alt_text_fr','alt_text_en'];
