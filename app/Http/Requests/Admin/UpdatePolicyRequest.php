...
class UpdatePolicyRequest extends FormRequest
{
    ...
    public function rules(): array { $policy=$this->route('policy'); $id=$policy instanceof Policy ? $policy->id : null; return ['title_fr'=>['required','string','max:255'],'title_en'=>['required','string','max:255'],'slug'=>['required','alpha_dash','max:255',Rule::unique('policies','slug')->ignore($id)],'content_fr'=>['required','string'],'content_en'=>['required','string'],'meta_title_fr'=>['nullable','string','max:255'],'meta_title_en'=>['nullable','string','max:255'],'meta_description_fr'=>['nullable','string'],'meta_description_en'=>['nullable','string'],'is_active'=>['nullable','boolean'],'sort_order'=>['nullable','integer']]; }
}
