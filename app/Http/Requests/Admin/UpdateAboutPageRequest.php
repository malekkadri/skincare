...
class UpdateAboutPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'meta_description_fr' => ['nullable','string'],'meta_description_en' => ['nullable','string'],'image' => ['nullable','image','mimes:jpg,jpeg,png,webp','max:3072'],'is_published' => ['nullable','boolean'],
        ];
    }
}
